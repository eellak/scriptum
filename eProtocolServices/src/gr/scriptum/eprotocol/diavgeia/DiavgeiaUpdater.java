...
public class DiavgeiaUpdater extends HttpDispatcher {
	...
	public DiavgeiaUpdater(DiavgeiaUpdaterConfig config) {
		setDebug(DEBUG);
		this.config = config;
	...
	public static void main(String gargv[]) {
		try {
			...
			DiavgeiaUpdater updater = new DiavgeiaUpdater( config );
