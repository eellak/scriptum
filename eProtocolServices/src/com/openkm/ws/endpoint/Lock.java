...
public class Lock  implements java.io.Serializable {
    ...
    /**
     * Gets the nodePath value for this Lock.
     * 
     * @return nodePath
     */
    ...
    /**
     * Sets the nodePath value for this Lock.
     * 
     * @param nodePath
     */
    ...
    /**
     * Gets the token value for this Lock.
     * 
     * @return token
     */
    ...
    /**
     * Sets the token value for this Lock.
     * 
     * @param token
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://endpoint.ws.openkm.com/", "lock"));
