...
public class QueryParams  implements java.io.Serializable {
    ...
    private java.lang.String statementQuery;
    ...
    public QueryParams(
           ...
           java.lang.String statementQuery,
    ...
    /**
     * Gets the shared value for this QueryParams.
     * 
     * @return shared
     */
    ...
    /**
     * Sets the shared value for this QueryParams.
     * 
     * @param shared
     */
    ...
    public java.lang.String getShared(int i) {
        return this.shared[i];
    }

    public void setShared(int i, java.lang.String _value) {
        this.shared[i] = _value;
    }


    /**
     * Gets the statementQuery value for this QueryParams.
     * 
    ...
    /**
     * Sets the statementQuery value for this QueryParams.
     * 
    ...
    /**
     * Gets the statementType value for this QueryParams.
     * 
    ...
    /**
     * Sets the statementType value for this QueryParams.
     * 
     * @param statementType
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            ((this.shared==null && other.getShared()==null) || 
             (this.shared!=null &&
              java.util.Arrays.equals(this.shared, other.getShared()))) &&
            ((this.statementQuery==null && other.getStatementQuery()==null) || 
             (this.statementQuery!=null &&
              this.statementQuery.equals(other.getStatementQuery()))) &&
            ((this.statementType==null && other.getStatementType()==null) || 
             (this.statementType!=null &&
              this.statementType.equals(other.getStatementType()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getShared() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getShared());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getShared(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
        ...
        if (getStatementQuery() != null) {
            _hashCode += getStatementQuery().hashCode();
        }
        if (getStatementType() != null) {
            _hashCode += getStatementType().hashCode();
        }
        if (getUser() != null) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.openkm.com", "queryParams"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://ws.openkm.com", ">>queryParams>properties>entry"));
        elemField.setNillable(false);
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("statementQuery");
        elemField.setXmlName(new javax.xml.namespace.QName("", "statementQuery"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("statementType");
        elemField.setXmlName(new javax.xml.namespace.QName("", "statementType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
