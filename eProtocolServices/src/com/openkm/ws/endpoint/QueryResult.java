...
public class QueryResult  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://endpoint.ws.openkm.com/", "queryResult"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://endpoint.ws.openkm.com/", "mail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
